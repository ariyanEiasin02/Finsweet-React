...
const Mission = () => {
  return (
    <div>
        <section className='md:py-20 py-12 bg-[#eef4fa]'>
            <div className="max-w-container mx-auto">
                <div className="px-4 md:px-0 flex flex-col-reverse md:flex-row justify-between gap-x-8 items-center">
                    <div className="md:w-2/4 mt-6 md:mt-0">
                        ...
                        <p className='mt-1 font-poppins font-normal text-[#282938] text-base md:w-[85%]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                ...
                <div className="md:flex px-4 md:px-0 mt-14 justify-between gap-x-8 items-center">
                    ...
                    <div className="md:w-2/4 mt-6 md:mt-0">
                        ...
                        <p className='mt-1 md:ml-4 font-poppins font-normal text-[#282938] text-base md:w-[85%]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
            </div>
        </section>
