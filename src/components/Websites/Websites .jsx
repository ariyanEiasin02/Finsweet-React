                    ...
                    <div className="md:flex justify-between">
                        ...
                        <div className="relative h-[450px] md:h-[600px]">
                            ...
                            <div style={{ background: "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5))" }} className="w-full h-full absolute top-0 left-0">
                                <div className="px-4 md:px-0">
                                    ...
                                    <p className="mt-[20px] font-poppins text-white font-noraml text-base md:pl-[50px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, <br /> sed do eiusmod tempor incididunt ut labore et dolore <br /> magna aliqua ut enim.</p>
                                </div>
                            </div>
                            </div>
                        </div>
                        <div className="md:w-2/4">
                            <div className="bg-[#1C1E53] h-[600px] py-12 px-4 md:px-0">
                                ...
                                <p className="mt-[20px] font-poppins text-white font-noraml text-base md:pl-[50px]">Lorem ipsum dolor sit amet, consectetur adipiscing <br/>elit, sed do eiusmod tempor incididunt ut labore.</p>
