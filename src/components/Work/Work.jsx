...
const Work = () => {
    return (
        <div>
            <section className='bg-[#F4F6FC] md:py-20 py-12'>
                <div className="max-w-container mx-auto">
                    <div className="md:flex justify-between px-4 md:px-0">
                        <div className="md:w-2/5">
                            <h2 className="font-poppins font-bold md:text-3xl text-2xl text-[#282938]">How we work</h2>
                            <p className="mt-[10px] font-poppins text-[#282938] font-normal w-full md:w-[80%] text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
                            <div className="mt-4">
                        ...
                        <div className="md:w-3/5 mt-8 md:mt-0">
                            <div className="flex flex-wrap gap-y-8 justify-between">
                                <div className="w-2/4">
                                    ...
                                    <p className="mt-[10px] font-poppins text-[#282938] font-light md:w-[90%] text-sm md:text-base">Euismod faucibus turpis eu gravida mi. Pellentesque et velit aliquam .</p>
                                </div>
                                <div className="w-2/4">
