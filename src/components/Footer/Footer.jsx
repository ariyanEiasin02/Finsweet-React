...
const Footer = () => {
    return (
        <div>
            <section className='md:pt-20 bg-[#1c1e53]'>
                <div className="max-w-container mx-auto">
                    <div className="md:flex py-12 md:py-0 justify-between gap-x-12 px-4 md:px-0">
                        <div className="md:w-2/4">
                            <img src={logo} alt="" />
                            <p className='font-poppins text-[#d2d2dd] font-normal text-base md:w-[70%] mt-4'>We are always open to discuss your project and improve your online presence.</p>
                            <div className="md:flex rounded-t-lg bg-[#fcd980] py-4 px-6 md:mt-20 mt-8">
                                <div className="">
                                    ...
                                    <p className='font-poppins text-[#000] font-normal text-sm mt-2'>ariyaneiasin56@gmail.com</p>
                                </div>
                                <div className="md:ml-12 mt-4 md:mt-0">
                                    <h6 className="font-poppins text-black text-lg font-normal">Call us</h6>
                                    <p className='font-poppins text-[#000] font-normal text-sm mt-2'>01704037578</p>
                                </div>
                            </div>
                        </div>
